  ...
  it("Should insert posted messages to the DB", function(done) {
    ...
    request({method: "POST",
            ...
            function(error, response, body) {
              ...
              console.log("Error on line 40");
              console.log (error);
              var queryString = "SELECT username, message FROM messages WHERE username = 'Valjean' and message = 'In mercys name, three days is all I need.'";
              var queryArgs = [];
